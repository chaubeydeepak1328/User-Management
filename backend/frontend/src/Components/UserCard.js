...
import { useToast, Modal, ModalOverlay, ModalContent, ModalHeader, ModalFooter, ModalBody, ModalCloseButton, Button, Input, Text } from '@chakra-ui/react';

const UserCard = ({ firstName, lastName, phoneNumber, email, address, sno, userId }) => {
            ...
            <tr>
                ...
                <td className='view-icon'>
                    <svg
                        ...
                        viewBox="0 0 16 16"
                    >
                        <g fill="none" stroke="green" strokeLinejoin="round" strokeWidth="0.93">
                ...
                <td className='edit-icon'>
                    <svg
                        ...
                        viewBox="0 0 24 24"
                    >
                        <g fill="none" stroke="blue" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
